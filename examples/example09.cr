...
f2=ftgen(0,   256,   7,  -1, 128, -1,   0,  1, 128,  1)
f3=ftgen(0,  256,   7,   1, 256, -1)
f4=ftgen(0,   256,   7,  -1, 128,  1, 128, -1)
f5=ftgen(0,   256,   7,   1,  64,  1,   0, -1,  192, -1)
f6=ftgen(0,  8192,   7,   0, 2048,  0,   0, -1, 2048, -1, 0, 1, 2048, 1, 0, 0, 2048, 0)

; Distortion Table
f7=ftgen(0, 1024,   8, -.8, 42, -.78,  400, -.7, 140, .7,  400, .78, 42, .8)
