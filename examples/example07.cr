...
#score
    ...
    synth:
     preset ='Amp1':[-12] + 'Type1':[1] + 'PW1':[0.5] + 'Tune1':[1]+'Oct1':[1] + 'FA':[0.1]+ 'FD':[0.1]+'FS':[0.5]+'FR':[0.1]+'AA':[0.01]+'AD':[0.2]+ 'AS':[0.5]+ 'AR':[0.01]+ 'Res':[0.5]+ 'CF':[5]
     preset+='Amp2':[-12] +  'Type2':[2]+ 'PW2':[0.3]+'Tune2':[1]+ 'Oct2':[2]
